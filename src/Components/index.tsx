...
import { ContentHeaderProps, ICatergoryItem, DropDownProps, BannerCarouselProps, GenreCarouselProps, CarouselProps, TActiveTitle, CatergoryItemModalContext, CatergoryItemModalContextType, ModalCarouselProps } from '../Models';
...
export const ContentHeader = ({style, state, handleState}:ContentHeaderProps)=> {
...
export const DropDown = ({list, setList}:DropDownProps) => {
...
export function BannerCarousel({style, tv, movies}: BannerCarouselProps): React.JSX.Element {
  const {height, width} = useWindowDimensions();
...
export function GenreCarousel({style, catergory}: GenreCarouselProps): React.JSX.Element{
  const {height, width} = useWindowDimensions();
  const {
    genre,
    setGenre,
...
export function TrendingMoviesCarousel({style}: CarouselProps): React.JSX.Element{
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems
  } = useContext(CatergoryItemModalContext)  as CatergoryItemModalContextType;
...
export function PopularMoviesCarousel({style}: CarouselProps): React.JSX.Element{
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems,
  } = useContext(CatergoryItemModalContext)  as CatergoryItemModalContextType;
...
export function TrendingTVShowsCarousel({style}: CarouselProps): React.JSX.Element{
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems
  } = useContext(CatergoryItemModalContext)  as CatergoryItemModalContextType;
...
export function DiscoverTVShowsCarousel({style}: CarouselProps): React.JSX.Element{
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems
  } = useContext(CatergoryItemModalContext)  as CatergoryItemModalContextType;
...
export const CatergoryItemModal = () => {
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems
  } = useContext(CatergoryItemModalContext)  as CatergoryItemModalContextType;
...
export const CatergoryItemsModal = () => {
  const {
    modalContextData, setModalContextData, setViewAll, viewAll, modalVisible, setModalVisible,
    modalTitle, setModalTitle, modalContextItems, setModalContexItems,
    genre,
...
export const FloatingContentSwitcher = () => {
  const {height, width} = useWindowDimensions();
